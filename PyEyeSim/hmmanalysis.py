...
def get_data(self, stim, tolerance=20):
    """
    ...
    XX, YY, list_lengths = self.DataArrayHmm(stim, tolerance=tolerance, verb=False)
...
def models_pipeline(self, stim, n_components_list, iteration=1, tollerance=20, simulation_type='random', evaluation='all', covariance_type='full', n_iter=10, starting_tests=1, only_starting=False, only_bic=False, only_best=False, threshold=0.5, models=None, subject=None):
    """
    ...
    """
    X, Y, list_lengths = get_data(self, stim, tollerance)
    ...
    return models, simulated_X, simulated_Y, list_len, likelihood_mat, n_components_list

def GaussianHMMPipeline(self, stim, n_components_list, iteration=1, tollerance=20, simulation_type='random', evaluation='all', covariance_type='full', n_iter=10, Summary=True, starting_tests=1, only_starting=False, only_bic=False, only_best=False, threshold=0.5, models=None, subject=None):
    """
    ...
    if isinstance(stim, int): 
        try:
            result = models_pipeline(self, stim, n_components_list, iteration, tollerance, simulation_type, evaluation, covariance_type, n_iter, starting_tests, only_starting, only_bic, only_best, threshold, models, subject)
            if only_starting:
                return result
            else:
        ...
        for s in stim:
            try:
                result = models_pipeline(self, s, n_components_list, iteration, tollerance, simulation_type, evaluation, covariance_type, n_iter, starting_tests, only_starting, only_bic, only_best, threshold, models, subject)
                if only_starting:
